...
import iconIntercomImage from "views/Conversation/images/Intercom.svg";

import languages from "../../languages.js";
import getLanguage from "getLanguage.js";
const language = languages[getLanguage()];

export class IntercomAgentNodeWidget extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div id="helpdesk-agent-node">
        <div className="helpdesk-agent-node--body">
          <img src={iconIntercomImage} />
          <div className="helpdesk-agent-node--info--kustomer">
            <p>
              <b>{language.continueIntercom}</b>
            </p>
          </div>
          {this.getInputPort()}
        </div>
