...
import ZendeskIcon from "views/Conversation/images/IconZendesk.svg";

import languages from "../../languages.js";
import getLanguage from "getLanguage.js";
const language = languages[getLanguage()];

export class ZendeskAgentNodeWidget extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div id="helpdesk-agent-node">
        <div className="helpdesk-agent-node--body">
          ...
          <div className="text-container">
            <p>
              <b>{language.continueHubSpot.replace("HubSpot", "Zendesk")}</b>
            </p>
          </div>
        </div>
      </div>
