...
import iconCustomImage from "views/Conversation/images/IconCustom.svg";

import languages from "../../languages.js";
import getLanguage from "getLanguage.js";
const language = languages[getLanguage()];

export class CustomAgentNodeWidget extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div id="helpdesk-agent-node">
        <div className="helpdesk-agent-node--body">
          <img src={iconCustomImage} />
          <div className="helpdesk-agent-node--info--kustomer">
            <p>
              <b>{language.continueCustom}</b>
            </p>
          </div>
          {this.getInputPort()}
        </div>
