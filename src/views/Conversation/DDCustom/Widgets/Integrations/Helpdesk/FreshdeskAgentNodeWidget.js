...
export class FreshdeskAgentNodeWidget extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div id="helpdesk-agent-node">
        <div className="helpdesk-agent-node--body">
          <img src={iconFreshdesk} />
          <div className="helpdesk-agent-node--info">
            <p>
              <b>{language.continueFreshdesk}</b>
            </p>
          </div>
          {this.getInputPort()}
        </div>
