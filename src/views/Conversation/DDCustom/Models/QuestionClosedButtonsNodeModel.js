...
export class QuestionClosedButtonsNodeModel extends QuestionNodeModel {
  constructor() {
    super();

    this.nodeType = "default-question-closed-buttons";
    this.className = "QuestionClosedButtonsNodeModel";
  ...
  duplicateClosedPort(port) {
    if (this.orderedClosedPorts.length >= BUTTONS_MAX) {
      return;
    }
